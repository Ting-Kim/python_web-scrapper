...
def add_to_dict(dic, name, description=None):
  if type(dic) is not dict:
    print('You need to send a dictionary. You sent: {}'.format(type(dic)))
    return
...
def update_word(dic, name, description=None):
  if type(dic) is not dict:
    print('You need to send a dictionary. You sent: {}'.format(type(dic)))
    return
  ...
  if name in dic:
    dic[name] = description
    print(f"{name} has been updated to: {description}")
  else:
